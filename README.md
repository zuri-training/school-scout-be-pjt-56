...
To do this, we navigated to the local school-scout-be-pjt-56 project folder and installed virtualenv.

```bash
# pip install virtualenv
```
This created a virtual environment, which was activated using `virtualenv school-scout-be-pjt-56`and we checked that pip and the necessary dependencies were properly installed.

The environment was activated by running the following command in the terminal..
```bash
source school-scout-be-pjt-56/scripts/activate
```
